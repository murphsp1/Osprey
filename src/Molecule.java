...
public class Molecule implements Serializable {
			...
			if (strand[i].residue[j].atom.length != strand[i].residue[j].numberOfAtoms) {
				...
				System.out
					.println("  Residue "
						...
						+ " of strand "
						+ i
						+ " has mismatched residue.atom.length residue.numberOfAtoms");
			    correct = false;
			}
		    }
		}
    ...
    private void expandMolecule(int numResidues, int numAtoms, int strandPos,
	    int residuePos) {
    ...
    public int deleteAtom(int strandNumber, int strandResidueNumber,
	...
	*/
	...
	theRotation.yAxisRotate(-a2YAngle, temporaryCoordinates,
		numberOfCoordinates);
	theRotation.zAxisRotate(180 - a2ZAngle, temporaryCoordinates,
		numberOfCoordinates);
	theRotation.xAxisRotate(deltaTorsion, temporaryCoordinates,
		numberOfCoordinates);
	theRotation.zAxisRotate(a2ZAngle - 180, temporaryCoordinates,
		numberOfCoordinates);
	theRotation.yAxisRotate(a2YAngle, temporaryCoordinates,
		numberOfCoordinates);
