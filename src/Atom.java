 ...
 * adding a bond between atoms, computing torsion, computing atom distance, etc.
 * Some of the data members include the atom name, radius, mass, coordinates,
...
public class Atom implements Serializable {
	...
	// The radii for C, H, N, O, P, S were changed to those used by the
	// Richardsons' PROBE;
	// The old radii are commented out to the side
		...
		|| ((name.toUpperCase().indexOf("H") == 1) && ((name.charAt(0) >= '0') && (name
			.charAt(0) <= '9')))) {
